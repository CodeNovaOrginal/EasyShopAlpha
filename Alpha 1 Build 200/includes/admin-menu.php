...
// The 'IS_ADMIN_PANEL' constant is defined in the main file that includes this menu.
?>
<nav>
    <ul>
        <li><strong>EasyShop <span class="alpha-tag">Alpha 1 Pre release</span></strong></li>
    </ul>
    <ul>
        <li><a href="index.php" <?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'aria-current="page"' : ''; ?>>Dashboard</a></li>

        <!-- NEW SHOP DROPDOWN MENU -->
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="orders.php" <?php echo (basename($_SERVER['PHP_SELF']) == 'orders.php') ? 'aria-current="page"' : ''; ?>>Orders</a></li>
            </ul>
        </li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="settings-easyshop.php" <?php echo (basename($_SERVER['PHP_SELF']) == 'settings-easyshop.php') ? 'aria-current="page"' : ''; ?>>EasyShop</a></li>
                <li><a href="settings-payment.php" <?php echo (basename($_SERVER['PHP_SELF']) == 'settings-payment.php') ? 'aria-current="page"' : ''; ?>>Payment</a></li>
            </ul>
        </li>
